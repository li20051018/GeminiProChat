...
export const post: APIRoute = async(context) => {
  ...
  const { sign, time, messages, pass, systemInstruction, temperature } = body
  ...
  try {
    ...
    const responseStream = await startChatAndSendMessageStream(history, newMessage, systemInstruction, temperature)
